...
<?php echo $this->Form->create('Product', array('type' => 'file')); ?>
	<fieldset>
		<legend><?php echo __('Admin sửa sản phẩm'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Xóa'), array('action' => 'delete', $this->Form->value('Product.id')), array(), __('Bạn có chắc chắn xóa # %s không?', $this->Form->value('Product.id'))); ?></li>
