...
<?php echo $this->Form->create('News',array('type'=>'file')); ?>
	<fieldset>
		<legend><?php echo __('Admin sửa tin tức'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Xóa'), array('action' => 'delete', $this->Form->value('News.id')), array(), __('Bạn có chắc chắn xóa # %s không?', $this->Form->value('News.id'))); ?></li>
